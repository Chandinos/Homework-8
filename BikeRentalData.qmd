...
Recipe1 <- recipe(TotalBikeCount ~ ., data = TrainingData) |>
  ...
  step_dummy(all_of(c("Seasons", "Holiday", "DayType")), one_hot = TRUE)
...
### Recipe 2: Same as Recipe 1 + interactions between seasons & holidays, seasons and temp, temp & rainfall.
```{r}
...
## Recipe 3: Same as Recipe 2 + adding in quadratic terms for each numeric predictor
```{r}
#Same as Recipe 2
